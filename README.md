...
- Reviews cutout edges with source/split/cutout modes, preview zoom, and quick backdrop toggles.
...
- Review controls update preview zoom, fit reset, and dark/checker backdrop state without affecting export quality.
