...
| --- | --- | --- |
| Transparent PNG | Source size | Raw cutout for compositing in other design tools |
| Marketplace square | 2000 x 2000 | Product cards, marketplaces, and print-like catalogues |
| Social avatar | 1080 x 1080 | Profile and social media images |
| Video thumbnail | 1280 x 720 | Channel thumbnails and social video cards |
